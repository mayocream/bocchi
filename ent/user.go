...
// was not loaded in eager-loading.
func (e UserEdges) RetweetsOrErr() ([]*Retweet, error) {
	if e.loadedTypes[2] {
...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldName, user.FieldUsername, user.FieldEmail, user.FieldPassword, user.FieldAvatar, user.FieldBanner, user.FieldBio:
...
func (u *User) QueryRetweets() *RetweetQuery {
