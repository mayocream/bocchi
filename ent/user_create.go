...
func (uc *UserCreate) AddRetweets(t ...*Tweet) *UserCreate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
func (uc *UserCreate) AddSentMessageIDs(ids ...int) *UserCreate {
	uc.mutation.AddSentMessageIDs(ids...)
	return uc
}

// AddSentMessages adds the "sent_messages" edges to the DirectMessage entity.
func (uc *UserCreate) AddSentMessages(d ...*DirectMessage) *UserCreate {
	ids := make([]int, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
...
func (uc *UserCreate) AddReceivedMessageIDs(ids ...int) *UserCreate {
	uc.mutation.AddReceivedMessageIDs(ids...)
	return uc
}

// AddReceivedMessages adds the "received_messages" edges to the DirectMessage entity.
func (uc *UserCreate) AddReceivedMessages(d ...*DirectMessage) *UserCreate {
	ids := make([]int, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
