...
type UserQuery struct {
	...
	withRetweets         *TweetQuery
	withLikes            *TweetQuery
...
func (uq *UserQuery) QueryRetweets() *TweetQuery {
	query := (&TweetClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) QueryLikes() *TweetQuery {
	query := (&TweetClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) QuerySentMessages() *DirectMessageQuery {
	query := (&DirectMessageClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) QueryReceivedMessages() *DirectMessageQuery {
	query := (&DirectMessageClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withRetweets:         uq.withRetweets.Clone(),
...
func (uq *UserQuery) WithRetweets(opts ...func(*TweetQuery)) *UserQuery {
	query := (&TweetClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withRetweets = query
	return uq
}
...
func (uq *UserQuery) WithLikes(opts ...func(*TweetQuery)) *UserQuery {
	query := (&TweetClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (uq *UserQuery) WithSentMessages(opts ...func(*DirectMessageQuery)) *UserQuery {
	query := (&DirectMessageClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (uq *UserQuery) WithReceivedMessages(opts ...func(*DirectMessageQuery)) *UserQuery {
	query := (&DirectMessageClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withRetweets; query != nil {
		if err := uq.loadRetweets(ctx, query, nodes,
			func(n *User) { n.Edges.Retweets = []*Tweet{} },
			func(n *User, e *Tweet) { n.Edges.Retweets = append(n.Edges.Retweets, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withLikes; query != nil {
		if err := uq.loadLikes(ctx, query, nodes,
			func(n *User) { n.Edges.Likes = []*Tweet{} },
			func(n *User, e *Tweet) { n.Edges.Likes = append(n.Edges.Likes, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := uq.withSentMessages; query != nil {
		if err := uq.loadSentMessages(ctx, query, nodes,
			func(n *User) { n.Edges.SentMessages = []*DirectMessage{} },
			func(n *User, e *DirectMessage) { n.Edges.SentMessages = append(n.Edges.SentMessages, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withReceivedMessages; query != nil {
		if err := uq.loadReceivedMessages(ctx, query, nodes,
			func(n *User) { n.Edges.ReceivedMessages = []*DirectMessage{} },
			func(n *User, e *DirectMessage) { n.Edges.ReceivedMessages = append(n.Edges.ReceivedMessages, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadRetweets(ctx context.Context, query *TweetQuery, nodes []*User, init func(*User), assign func(*User, *Tweet)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.RetweetsTable)
		s.Join(joinT).On(s.C(tweet.FieldID), joinT.C(user.RetweetsPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.RetweetsPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.RetweetsPrimaryKey[0]))
...
func (uq *UserQuery) loadLikes(ctx context.Context, query *TweetQuery, nodes []*User, init func(*User), assign func(*User, *Tweet)) error {
	edgeIDs := make([]driver.Value, len(nodes))
	byID := make(map[int]*User)
	nids := make(map[int]map[*User]struct{})
	for i, node := range nodes {
	...
	query.Where(func(s *sql.Selector) {
		...
		s.Join(joinT).On(s.C(tweet.FieldID), joinT.C(user.LikesPrimaryKey[1]))
...
func (uq *UserQuery) loadSentMessages(ctx context.Context, query *DirectMessageQuery, nodes []*User, init func(*User), assign func(*User, *DirectMessage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	for _, n := range neighbors {
		fk := n.user_sent_messages
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_sent_messages" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_sent_messages" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (uq *UserQuery) loadReceivedMessages(ctx context.Context, query *DirectMessageQuery, nodes []*User, init func(*User), assign func(*User, *DirectMessage)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	for _, n := range neighbors {
		fk := n.user_received_messages
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_received_messages" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_received_messages" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
