...
func (nc *NotificationCreate) SetNillableUserID(id *int) *NotificationCreate {
	if id != nil {
		nc = nc.SetUserID(*id)
	}
	return nc
...
func (nc *NotificationCreate) SetRelatedTweetID(id int) *NotificationCreate {
	nc.mutation.SetRelatedTweetID(id)
	return nc
}

// SetNillableRelatedTweetID sets the "related_tweet" edge to the Tweet entity by ID if the given value is not nil.
func (nc *NotificationCreate) SetNillableRelatedTweetID(id *int) *NotificationCreate {
	if id != nil {
		nc = nc.SetRelatedTweetID(*id)
	}
	return nc
}

// SetRelatedTweet sets the "related_tweet" edge to the Tweet entity.
func (nc *NotificationCreate) SetRelatedTweet(t *Tweet) *NotificationCreate {
	return nc.SetRelatedTweetID(t.ID)
}

// SetRelatedUserID sets the "related_user" edge to the User entity by ID.
func (nc *NotificationCreate) SetRelatedUserID(id int) *NotificationCreate {
	nc.mutation.SetRelatedUserID(id)
	return nc
}

// SetNillableRelatedUserID sets the "related_user" edge to the User entity by ID if the given value is not nil.
func (nc *NotificationCreate) SetNillableRelatedUserID(id *int) *NotificationCreate {
	if id != nil {
		nc = nc.SetRelatedUserID(*id)
	}
	return nc
}
...
func (nc *NotificationCreate) createSpec() (*Notification, *sqlgraph.CreateSpec) {
	...
	if nodes := nc.mutation.RelatedTweetIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
		...
		_node.notification_related_tweet = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	if nodes := nc.mutation.RelatedUserIDs(); len(nodes) > 0 {
		...
		_node.notification_related_user = &nodes[0]
		_spec.Edges = append(_spec.Edges, edge)
	}
	return _node, _spec
}
